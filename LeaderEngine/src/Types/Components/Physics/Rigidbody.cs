...
namespace LeaderEngine
{
    public class Rigidbody : Component
    {
        ...
        private void OnPhysicsUpdate(Simulation sim)
        {
            ...
            BaseTransform.LocalPosition = new OpenTK.Mathematics.Vector3(body.Pose.Position.X, body.Pose.Position.Y, body.Pose.Position.Z);
            BaseTransform.Rotation = new OpenTK.Mathematics.Quaternion(body.Pose.Orientation.X, body.Pose.Orientation.Y, body.Pose.Orientation.Z, body.Pose.Orientation.W);
        }
